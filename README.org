#+startup: show2levels
#+html: <div>
#+html: <a href="https://github.com/rennsax/dotfiles/actions/workflows/ci.yml"><img alt="GitHub Actions Workflow Status" src="https://img.shields.io/github/actions/workflow/status/rennsax/dotfiles/ci.yml?label=Test"></a>
#+html: <a href="https://github.com/rennsax/dotfiles/releases"><img alt="GitHub Release" src="https://img.shields.io/github/v/release/rennsax/dotfiles"></a>
